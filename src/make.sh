...
java -ea -verify -Xms256M -Xmx256M -Xfuture -Xnoclassgc -classpath ../bin/symade-06.jar:../bin/xpp3-1.1.4c.jar -Dsymade.dump.old=false kiev.Main -classpath ${OUT_ROOT}/classes:../bin/xpp3-1.1.4c.jar -d ${OUT_ROOT}/classes -verify -enable vnode -enable view -p k5.prj -prop k5.props -g $* 
