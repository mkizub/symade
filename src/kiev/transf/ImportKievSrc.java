...
public final class KievFE_Pass1 extends TransfProcessor {
	...
	private void processFileHeader(FileUnit fu) {
		...
		String kiev_stdlib_syntax = "kiev.stdlib.Syntax";
		...
		if( !any_syntax ) {
			Import imp = new Import(Env.newStruct("Syntax",Env.newPackage(kiev_stdlib_name),ACC_SYNTAX,new KievSyntax()),false);
