 ...
 */
 ...
 /*@bgen(jjtree) Annotation */
  ...
  static final public void AnnotationValue() throws ParseException {
  ...
  jjtree.openNodeScope(jjtn000);Token t;
    try {
      try {
        ...
        label_37:
        while (true) {
          if (jj_2_51(1) && (Kiev.enabled(Ext.Typedef)&&checkNoSpace(getToken(0),getToken(1)))) {
            ;
          } else {
            break label_37;
          }
 ...
 */
 ...
 /*@bgen(jjtree) TryStatement */
  ...
  static final private boolean jj_3R_345() {
    ...
    lookingAhead = false;
    if (!jj_semLA || jj_3R_364()) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    if (jj_3R_115()) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
  ...
  static final private boolean jj_3R_387() {
    ...
    jj_semLA = getToken(1).kind == IDENTIFIER
         && getToken(2).kind == IS_THE;
    lookingAhead = false;
    if (!jj_semLA || jj_3R_413()) {
    jj_scanpos = xsp;
    lookingAhead = true;
    jj_semLA = getToken(1).kind == IDENTIFIER
         && getToken(2).kind == IS_ONE_OF;
    lookingAhead = false;
    if (!jj_semLA || jj_3R_414()) {
    jj_scanpos = xsp;
    lookingAhead = true;
