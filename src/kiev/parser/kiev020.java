 ...
 */
    ...
    try {
      ...
      while (true) {
        ...
        try {
          ...
          } else if (getToken(1).kind==IDENTIFIER && getToken(1).image.equals("syntax")) {
            SyntaxDeclaration();
            switch (jj_nt.kind) {
            case SEMICOLON:
              jj_consume_token(SEMICOLON);
 ...
 /*@bgen(jjtree) Opdef */
  ...
  static final public void SyntaxDeclaration() throws ParseException {
      ...
      try {
        ...
        default:
          ...
          throw new ParseException();
                              ...
                              rpe("Bad start of class declaration",e);
      } catch (Throwable e) {
                             rperr(e);
      }
 ...
 /*@bgen(jjtree) EnumDeclaration */
    ...
    try {
      try {
        ...
        jj_consume_token(ENUM);
                              ...
                              rpe("Bad start of enum declaration",e);
      } catch (Throwable e) {
                             rperr(e);
      }
      try {
  ...
  static final public void CaseTypeDeclaration() throws ParseException {
 ...
 /*@bgen(jjtree) Modifier */
  ...
  static final public void ModifierConst() throws ParseException {
 /*@bgen(jjtree) Modifier */
  ASTModifier jjtn000 = new ASTModifier(JJTMODIFIER);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token t=null;
...
*/
 ...
 /*@bgen(jjtree) NewInitializedArrayExpression */
  ...
  static final public ASTFormalParameter FormalParameter() throws ParseException {
 /*@bgen(jjtree) FormalParameter */
  ...
  static final public ASTFormalParameter mmFormalParameter() throws ParseException {
 /*@bgen(jjtree) FormalParameter */
  ASTFormalParameter jjtn000 = new ASTFormalParameter(JJTFORMALPARAMETER);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token t;
    ...
    try {
      ...
      case IDENTIFIER:
        //LOOKAHEAD({
                        ...
                        //	(  getToken(1).image.equals("prefix")
                        //	|| getToken(1).image.equals("suffix")
                        //	|| getToken(1).image.equals("postfix")
                        //	|| getToken(1).image.equals("infix")
                        //	|| getToken(1).image.equals("binary")
                        //	)
                        //})
                        t = jj_consume_token(IDENTIFIER);
                                 jjtn000.set(t);
...
//		try {
//		[
//			MacroFormalParameter()
//			( "," MacroFormalParameter() )*
//		]
//		}
//		catch(ParseError e) { rpe("Macro formal parameter(s) expected",e); }
...
//		[ ";" ]
//	}
//	catch(ParseError e) { rpe("Macro body expected",e); }
//	catch(Throwable e) { rperr(e); }
//}

//void MacroFormalParameter() :
//{}
//{
//	(
//		(	"<expr>"	{ jjtThis.mode = ASTMacroFormalParameter.MODE_EXPR; }
//		|	"<const>"	{ jjtThis.mode = ASTMacroFormalParameter.MODE_CONST; }
//		)
//		[	LOOKAHEAD({ getToken(2).kind != COMMA && getToken(2).kind != RPAREN })
//			Type()
//		]
//		Identifier()
//	|
//		(	"<stat>"	{ jjtThis.mode = ASTMacroFormalParameter.MODE_STAT; }
//		|	"<type>"	{ jjtThis.mode = ASTMacroFormalParameter.MODE_TYPE; }
//		|	"<text>"	{ jjtThis.mode = ASTMacroFormalParameter.MODE_TEXT; }
//		)
//		Identifier()
//	)
//}
 ...
 /*@bgen(jjtree) EnsureDeclaration */
  ...
  static final public void InvariantDeclaration() throws ParseException {
 ...
 /*@bgen(jjtree) RuleDeclaration */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);ASTBlock bl; ASTFormalParameter lv;
    try {
      if (jj_2_36(2)) {
      ...
      while (true) {
        ...
        lv = FormalParameter();
                                       lv.setLocalPrologVar(true); lv = null;
        jj_consume_token(SEMICOLON);
      }
      try {
  ...
  jjtree.openNodeScope(jjtn000);Token t;
    try {
      try {
        ...
        label_43:
        while (true) {
          if (jj_2_40(1) && (checkNoSpace(getToken(0),getToken(1)))) {
            ;
          } else {
            break label_43;
          }
    ...
    while (true) {
      ...
      if (jj_2_56(3)) {
        ...
        try {
          ...
          jjtc005 = false;
          jjtn005.setPos(t.getPos()); jjtn005.in_wrapper=true;
        } finally {
          if (jjtc005) {
            jjtree.closeNodeScope(jjtn005,  2);
          }
 ...
 */
 ...
 /*@bgen(jjtree) CondBlock */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);boolean old_declMode; boolean rbrace_req = false;
    try {
      switch (jj_nt.kind) {
      case LBRACE:
        jj_consume_token(LBRACE);
 ...
 /*@bgen(jjtree) TryStatement */
  ...
  static final private boolean jj_3R_262() {
    if (jj_scan_token(EXPORT_CPP)) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    return false;
  }
  ...
  static final private boolean jj_3R_260() {
    if (jj_scan_token(PVAR)) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    return false;
  }
  ...
  static final private boolean jj_3R_347() {
    ...
    lookingAhead = false;
    if (!jj_semLA || jj_3R_409()) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    if (jj_3R_105()) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    return false;
