...
import kiev.stdlib.KString;

/**
 * $Header: /home/CVSROOT/forestro/kiev/kiev/parser/KToken.java,v 1.2 1998/10/21 19:44:38 max Exp $
 * @author Maxim Kizub
...
public class KToken {
	...
	public KToken(Token t) {
		pos = t.pos; //(t.beginLine <<11) | (t.beginColumn & 0x3FF);
		image = KString.from(t.image);
	}
