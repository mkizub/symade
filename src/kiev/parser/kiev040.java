...
// disabled
  static final public void Generate(KString name, NArrTypeWithArgsRefs types) throws ParseException {
  Token t; ASTIdentifier id; TypeWithArgsRef tp;
    ...
    case VOID:
    case RULE:
      tp.args += PrimitiveType();
      break;
    case IDENTIFIER:
      id = Name();
                                                             tp.args += new TypeNameRef(id);
      break;
    default:
      jj_consume_token(-1);
      throw new ParseException();
  ...
  static final public ASTFieldDecl FieldDecl(ASTModifiers modifiers, TypeRef type, boolean first) throws ParseException {
  Token t;
  ...
  Token t;
    ...
    if (jj_2_27(1)) {
      ...
      while (true) {
        ...
        t= jj_consume_token(OPERATOR_LRBRACKETS);
                                            n.type = new TypeExpr(n.type,t); if (n.mm_type != null) n.mm_type = new TypeExpr(n.mm_type,t);
      }
    } else {
      switch (jj_nt.kind) {
      case UNDERSCORE:
  ...
  Token t;
    ...
    while (true) {
      ...
      t= jj_consume_token(OPERATOR_LRBRACKETS);
                                          n.rettype = new TypeExpr(n.rettype,t);
    }
    label_32:
    while (true) {
      switch (jj_nt.kind) {
 ...
 */
  ...
  ASTIdentifier id; TypeRef res; TypeRef arg; TypeWithArgsRef tra;
    ...
    if (jj_2_50(1) && (Kiev.enabled(Ext.Generics))) {
      jj_consume_token(LT);
