 ...
 */
  ...
  RewriteNode rn; Token t;
    switch (jj_nt.kind) {
    case OPERATOR_SHARP:
      jj_consume_token(OPERATOR_SHARP);
      t= jj_consume_token(IDENTIFIER);
                  rn = new RewriteNodeFactory(t.image);
      RewriteNodeArgs((RewriteNodeFactory)rn);
      break;
    case IDENTIFIER:
      t= jj_consume_token(IDENTIFIER);
                  rn = new RewriteNodeVar(t.image);
      label_79:
      while (true) {
        switch (jj_nt.kind) {
        case DOT:
        ...
        jj_consume_token(DOT);
        t= jj_consume_token(IDENTIFIER);
                          rn = new RewriteNodeAccess(rn, t.image);
      }
      break;
    default:
      jj_consume_token(-1);
  ...
  final private boolean jj_3R_213() {
    ...
    lookingAhead = false;
    if (!jj_semLA || jj_3R_423()) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    if (jj_3R_137()) return true;
    if (jj_3R_101()) return true;
    xsp = jj_scanpos;
