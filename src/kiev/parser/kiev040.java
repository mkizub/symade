...
public abstract class kiev040 implements kiev040Constants {
	...
	private Struct mkStruct(Symbol name, int flags, ASTModifiers modifiers, ASTNode parent) {
		...
		if (parent instanceof FileUnit) {
			...
			Env.createProjectInfo(clazz.qname(), String.valueOf(Kiev.curFile));
		}
		else if (parent instanceof Struct)
 ...
 */
  ...
  final public MetaType MetaTypeDeclaration(ASTModifiers modifiers, FileUnit parent) throws ParseException {
  MetaType mt; Symbol name; Struct oldClazz;
    jj_consume_token(METATYPE);
    name = Name();
                mt = mkMetaType(name, modifiers, parent);
    ...
    try {
      ...
      while (true) {
        ...
        modifiers = Modifiers();
        FieldDecls(modifiers, mt.members);
      }
      jj_consume_token(RBRACE);
    } finally {
                    curClazz = oldClazz;
  ...
  final public void FieldDecls(ASTModifiers modifiers, NArrNodes members) throws ParseException {
  ...
  Token t; Symbol id; Field f; Symbol func; ASTNode body;
    id = Name();
        ...
        while (true) {
          ...
          default:
            ...
            throw new ParseException();
                                        ...
                                        if (func.sname.equals("get"))
                                                f.getter = body;
                                        else if (func.sname.equals("set"))
                                                f.setter = body;
                                        else if (func.sname.equals("init"))
                                                f.initializer = body;
                                        else
                                                kiev.Kiev.reportParserError(func.pos, "Expected get/set/init bodies");
          switch (jj_nt.kind) {
          case IDENTIFIER:
            ;
            break;
 ...
 */
  ...
  final public RewriteNode RewriteCode() throws ParseException {
  RewriteNode rn;
    switch (jj_nt.kind) {
    case AST_SELF:
      jj_consume_token(AST_SELF);
                                                  rn = new RewriteNodeSelf();
      break;
    case AST_CALL:
      jj_consume_token(AST_CALL);
                                                  rn = new RewriteNodeCall();
      RewriteNodeArgs(rn);
      break;
    case AST_ARRAY_LENGTH:
      jj_consume_token(AST_ARRAY_LENGTH);
                                          rn = new RewriteNodeArrayLength();
      RewriteNodeArgs(rn);
      break;
    default:
      jj_consume_token(-1);
  ...
  final public void RewriteNodeArgs(RewriteNode rn) throws ParseException {
    jj_consume_token(LPAREN);
    switch (jj_nt.kind) {
    case AST_CALL:
    case AST_ARRAY_LENGTH:
  ...
  final private boolean jj_3_14() {
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_scan_token(179)) { jj_scanpos = xsp; break; }
    }
    xsp = jj_scanpos;
  ...
  final private boolean jj_3R_212() {
    ...
    lookingAhead = false;
    if (!jj_semLA || jj_3R_422()) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    if (jj_3R_136()) return true;
    if (jj_3R_100()) return true;
    xsp = jj_scanpos;
  ...
  final private boolean jj_3R_387() {
    ...
    lookingAhead = false;
    if (!jj_semLA || jj_3R_411()) {
    jj_scanpos = xsp;
    lookingAhead = true;
    jj_semLA = getToken(1).kind == LBRACE;
    lookingAhead = false;
    if (!jj_semLA || jj_3R_412()) {
    jj_scanpos = xsp;
    lookingAhead = true;
  ...
  final private boolean jj_3R_519() {
    if (jj_scan_token(AST_ARRAY_LENGTH)) return true;
  ...
  final private boolean jj_3R_518() {
    if (jj_scan_token(AST_CALL)) return true;
    if (jj_3R_523()) return true;
    return false;
  }

  final private boolean jj_3R_517() {
    if (jj_scan_token(AST_SELF)) return true;
    return false;
  }
