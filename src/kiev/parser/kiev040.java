 ...
 */
  ...
  final public SpecialAttrSlot SpecialAnnotation() throws ParseException {
    switch (jj_nt.kind) {
    case META_SINGLETON:
 ...
 */
  ...
  final private boolean jj_3_106() {
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_scan_token(164)) { jj_scanpos = xsp; break; }
    }
    xsp = jj_scanpos;
  ...
  final private boolean jj_3R_203() {
    ...
    lookingAhead = false;
    if (!jj_semLA || jj_3R_377()) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    if (jj_3R_128()) return true;
    if (jj_3R_92()) return true;
    xsp = jj_scanpos;
  ...
  final public void disable_tracing() {
	...
	private Struct mkStruct(NameRef name, int flags, ASTModifiers modifiers, ASTNode parent) {
		...
		foreach (SpecialAttrSlot sa; modifiers.specials)
			sa.attach(clazz);
