 ...
 */
  ...
  ASTIdentifier id; ASTOperator op; ASTType tp; ASTTypedef n = new ASTTypedef();
  ...
  static final public ASTEnumFieldDeclaration EnumFieldDeclaration(ASTModifiers modifiers) throws ParseException {
  ASTEnumFieldDeclaration n = new ASTEnumFieldDeclaration();
          n.modifiers = modifiers;
    n.name = Name();
    switch (jj_nt.kind) {
    case ASSIGN:
      jj_consume_token(ASSIGN);
      n.val  = IntConstExpression();
      break;
    default:
      ;
    }
  ...
  Token t; ASTNonArrayType tp;
    jj_consume_token(GENERATE);
          tp = new ASTNonArrayType(KString.Empty);
    jj_consume_token(LT);
    switch (jj_nt.kind) {
    case BOOLEAN:
    case BYTE:
  ...
  static final public ASTModifier Modifier() throws ParseException {
  Token t=null;
    switch (jj_nt.kind) {
    case PUBLIC:
    ...
    default:
      ...
      throw new ParseException();
          ...
          ASTModifier n = new ASTModifier(); n.set(t); {if (true) return n;}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ASTFieldDecl FieldDecl(ASTModifiers modifiers, ASTType type, boolean first) throws ParseException {
                ASTFieldDecl n = new ASTFieldDecl();
                if (first) {
                        n.modifiers = modifiers;
                        n.type = type;
                } else {
  ...
  static final public ASTVarDecls VarDecls(ASTModifiers modifiers) throws ParseException {
  ...
  static final public Expr VariableInitializer() throws ParseException {
  Expr e;
    switch (jj_nt.kind) {
    case LBRACE:
      e = ArrayInitializer();
  ...
  static final public Expr ArrayInitializer() throws ParseException {
  ...
  Token t;
    ...
    if (jj_2_27(1)) {
      ...
      while (true) {
        ...
        t= jj_consume_token(LBRACKET);
        jj_consume_token(RBRACKET);
                              n.type.addOperation(t); if (n.mm_type != null) n.mm_type.addOperation(t);
      }
    } else {
      switch (jj_nt.kind) {
      case UNDERSCORE:
  ...
  static final public ASTThrows Throws() throws ParseException {
  ...
  static final public ASTBlock MaybeSkipBlock() throws ParseException {
  ...
  static final public ASTMethodDeclaration MethodDeclaration(ASTModifiers modifiers) throws ParseException {
  Token t;
    ...
    if (jj_2_33(1)) {
      ...
      if (jj_2_32(2) && (Kiev.enabled(Ext.VarArgs))) {
        switch (jj_nt.kind) {
        case COMMA:
          jj_consume_token(COMMA);
          break;
  ...
  static final public ASTMethodDeclaration ConstructorDeclaration(ASTModifiers modifiers) throws ParseException {
  Token t;
                ASTMethodDeclaration n = new ASTMethodDeclaration();
                n.modifiers = modifiers;
    n.ident = Name();
    ...
    if (jj_2_37(1)) {
      ...
      if (jj_2_36(2) && (Kiev.enabled(Ext.VarArgs))) {
        switch (jj_nt.kind) {
        case COMMA:
          jj_consume_token(COMMA);
          break;
  ...
  static final public ASTRuleDeclaration RuleDeclaration(ASTModifiers modifiers) throws ParseException {
  ASTBlock bl;
 ...
 */
    ...
    case IDENTIFIER:
      ...
      while (true) {
        ...
        if (jj_2_51(2)) {
          ...
          jj_consume_token(RBRACKET);
                          res.addOperation(t);
        } else if (jj_2_52(1) && (Kiev.enabled(Ext.Typedef)&&checkNoSpace(getToken(0),getToken(1)))) {
          t= TypeOperatorChar();
                          res.addOperation(t);
        } else {
          jj_consume_token(-1);
  ...
  Token t; ASTNonArrayType n = new ASTNonArrayType();
    n.children += QName();
    if (jj_2_54(1) && (Kiev.enabled(Ext.Generics))) {
      jj_consume_token(LT);
      n.children += Type();
      label_43:
      while (true) {
    ...
    label_44:
    while (true) {
      if (jj_2_55(1) && (Kiev.enabled(Ext.Typedef)&&checkNoSpace(getToken(0),getToken(1)))) {
        ;
      } else {
        break label_44;
      }
  ...
  Token t;
    ...
    default:
      ...
      throw new ParseException();
          ...
          ASTPrimitiveType n = new ASTPrimitiveType(); n.set(t); {if (true) return n;}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  ...
  static final public ASTNode CastOperator() throws ParseException {
  ...
  static final public Expr ExpressionNT(int[] nt_new) throws ParseException {
  ...
  static final public Expr ReparseExpression() throws ParseException {
  ...
  static final public Expr CallExpression() throws ParseException {
  ...
  static final public Expr CallAccessExpression(Expr obj) throws ParseException {
  ...
  static final public Expr TypeClassExpression() throws ParseException {
  ...
  static final public Expr AccessExpression() throws ParseException {
  Token t; Expr e = null;
 ...
 */
  ...
  static final public ASTRuleBlock RuleBlock() throws ParseException {
  boolean old_declMode;
    jj_consume_token(LBRACE);
  ...
  static final public ASTNode BlockStatement(ASTNode parent) throws ParseException {
  ...
  static final public ASTNode CaseStatements() throws ParseException {
  ASTNode st;
  ...
  static final public ASTNormalCase NormalCase() throws ParseException {
  ...
  static final public ASTPizzaCase PizzaCase() throws ParseException {
  ...
  static final public ASTDoStatement DoStatement() throws ParseException {
  ...
  static final public ASTForEachStatement ForEachStatement() throws ParseException {
  ...
  static final public ASTNode ForInit() throws ParseException {
  ...
  static final public ASTGotoStatement GotoStatement() throws ParseException {
  ...
  static final public ASTThrowStatement ThrowStatement() throws ParseException {
  ...
  static final public ASTSynchronizedStatement SynchronizedStatement() throws ParseException {
  ...
  static final public ASTWithStatement WithStatement() throws ParseException {
  ...
  static final public ASTTryStatement TryStatement() throws ParseException {
  ...
  static final public ASTCatchInfo CatchInfo() throws ParseException {
  ...
  static final public ASTFinallyInfo FinallyInfo() throws ParseException {
  ...
  static final private boolean jj_3R_286() {
    ...
    jj_semLA = getToken(1).kind == IDENTIFIER
                 && getToken(2).kind == IS_THE;
    lookingAhead = false;
    if (!jj_semLA || jj_3R_306()) {
    jj_scanpos = xsp;
    lookingAhead = true;
    jj_semLA = getToken(1).kind == IDENTIFIER
                 && getToken(2).kind == IS_ONE_OF;
    lookingAhead = false;
    if (!jj_semLA || jj_3R_307()) {
    jj_scanpos = xsp;
    lookingAhead = true;
    jj_semLA = getToken(1).kind == PCUT;
    lookingAhead = false;
    if (!jj_semLA || jj_3R_308()) {
    jj_scanpos = xsp;
    lookingAhead = true;
