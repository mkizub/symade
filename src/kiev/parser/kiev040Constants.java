...
public interface kiev040Constants {
  ...
  int COMMA1 = 86;
  int PRAGMA = 92;
  int PRAGMA_ENABLE = 93;
  int PRAGMA_DISABLE = 94;
  int INTEGER_LITERAL = 95;
  int LONG_INTEGER_LITERAL = 96;
  int DECIMAL_LITERAL = 97;
  int HEX_LITERAL = 98;
  int OCTAL_LITERAL = 99;
  int FLOATING_POINT_LITERAL = 100;
  int DOUBLE_POINT_LITERAL = 101;
  int EXPONENT = 102;
  int REPARSE_EXPRESSION = 103;
  int REPARSE_STATEMENT = 104;
  int REPARSE_TYPE = 105;
