...
public class Window extends JFrame implements ActionListener, FocusListener {
	...
	public Window() {
		...
		info_view   = new InfoView(this, ((ATextSyntax)Env.loadDNodeFromXML("stx-fmt\u001fsyntax-for-java")).getCompiled(), info_canvas);
		clip_view   = new InfoView(this, ((ATextSyntax)Env.loadDNodeFromXML("stx-fmt\u001fsyntax-for-java")).getCompiled(), clip_canvas);
		expl_view   = new TreeView(this, ((TreeSyntax)Env.loadDNodeFromXML("stx-fmt\u001fsyntax-for-project-tree")).getCompiled(), expl_tree);
	...
	public void openEditor(FileUnit fu, ANode[] path) {
		...
		Editor editor_view = new Editor  (this, ((ATextSyntax)Env.loadDNodeFromXML("stx-fmt\u001fsyntax-for-java")).getCompiled(), edit_canvas);
