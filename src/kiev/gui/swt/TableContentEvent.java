...
public class TableContentEvent extends EventObject {
...
//	Constructors
	 ...
	 *  have not changed.  
	 */
	public TableContentEvent(Object source) {
	 ...
	 */
	public TableContentEvent(Object source, int row) {
	 ...
	 */
	public TableContentEvent(Object source, int firstRow, int lastRow) {
	 ...
	 */
	public TableContentEvent(Object source, int firstRow, int lastRow, int column) {
	 ...
	 */
	public TableContentEvent(Object source, int firstRow, int lastRow, int column, int type) {
		super(source);
