...
public class Editor extends InfoView implements KeyListener, ElementChangeListener {
	...
	public void formatAndPaint(boolean full) {
		...
		cur_elem.restore();
		view_canvas.setCurrent(cur_elem.dr);
		view_canvas.setCurrent_node(cur_elem.node);
		if (full) {
	...
	public void makeCurrentVisible() {
		try {
			int top_lineno = view_canvas.getFirst_visible().getGfxFmtInfo().getLineNo();
			int bot_lineno = view_canvas.getLast_visible().getGfxFmtInfo().getLineNo();
	...
	public final class CurElem {
		...
		public void set(DrawTerm dr) {
			...
			Editor.this.view_canvas.setCurrent(dr);
			Editor.this.view_canvas.setCurrent_node(node);
			if (dr != null) {
