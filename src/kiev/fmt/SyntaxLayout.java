...
public class SyntaxList extends SyntaxAttr {
	...
	public SyntaxList() {}
	public SyntaxList(String name, SpaceCmd[] spaces) {
		super(name,spaces);
		this.element = new SyntaxNode();
		this.folded = new SyntaxToken("{?"+name+"?}", new SpaceCmd[0]);
