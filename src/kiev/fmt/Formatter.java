...
public interface Formatter {
	public void       format(ANode node, Drawable dr, ATextSyntax syntax);
...
public abstract class AbstractFormatter implements Formatter {
	...
	public abstract void format(ANode node, Drawable dr, ATextSyntax syntax);
	...
	public final Drawable getDrawable(ANode node, Drawable dr, ATextSyntax text_syntax) {
