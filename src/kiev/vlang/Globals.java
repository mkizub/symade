...
public metatype Globals extends any {
	...
	{
		case CallExpr# self():
			new #CallExpr(obj=kiev.stdlib.#id"any"#,ident="ref_assign",args={lval,new #CallExpr(obj=val,ident="get$$var")})
		case AssignExpr# self():
			new #AssignExpr(lval=self.lval,op=self.op,value=new #CallExpr(obj=self.value,ident="get$$var"))
	}

	@macro
	public static <L extends Object, R extends L> R ref_pvar_bind(L@ lval, R val) alias lfy operator =
	{
		case CallExpr# self():
