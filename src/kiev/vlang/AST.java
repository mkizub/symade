...
@node
@dflow(out="this:in")
public class VarRef extends ENode {
	@att
	KString							name;
	@ref
	public virtual forward Var		lnk;
	...
	public VarRef(int pos, Var var) {
		super(pos);
		this.lnk = var;
	}
	public VarRef(KString name) {
		this.name = name;
	}
	public VarRef(int pos, KString name) {
		super(pos);
		this.name = name;
	}
	...
	public void set$lnk(Var var) {
		this.lnk = var;
		if (var != null && (this.name == null || !var.name.equals(name)))
			this.name = var.name.name;
	}
	...
	public boolean equals(Object o) {
		if (o instanceof Var) return this.lnk == o;
		return this == o;
	}
	...
	public static Enumeration<Var> linked_elements(NArr<VarRef> arr) {
		Vector<Var> tmp = new Vector<Var>();
		foreach (VarRef tr; arr) { if (tr.lnk != null) tmp.append(tr.lnk); }
		return tmp.elements();
	}
}
