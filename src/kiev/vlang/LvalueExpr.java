...
public final class AccessExpr extends LvalueExpr {
	...
	public void mainResolveOut() {
		...
		for (int si=0; si < tps.length; si++) {
			...
			DNode@ v;
			ResInfo info;
			if (tp.resolveNameAccessR(v,info=new ResInfo(this,this.ident,ResInfo.noStatic | ResInfo.noSyntaxContext)) ) {
...
public final class IFldExpr extends LvalueExpr {
	...
	public void mainResolveOut() {
		...
		for (int si=0; si < len; si++) {
			...
			Field@ v;
			ResInfo info;
			if (tp.resolveNameAccessR(v,info=new ResInfo(this,this.ident,ResInfo.noStatic | ResInfo.noSyntaxContext | ResInfo.noForwards)) ) {
				res[si] = v;
			}
		}
		int cnt = 0;
	...
	public boolean preVerify() {
		...
		if (!f.isAttached()) {
			...
			DNode@ v;
			ResInfo info;
			if (tp.resolveNameAccessR(v,info=new ResInfo(this,f.sname,ResInfo.noStatic | ResInfo.noSyntaxContext)) ) {
