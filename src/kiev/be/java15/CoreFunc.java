...
//		coreFuncs.put("kiev.stdlib.any:ref_neq",            ObjectBoolNE);
		...
		coreFuncs.put("kiev.stdlib.boolean:assign_bit_or",  new AssignWithOpFunc(Instr.op_or));
		coreFuncs.put("kiev.stdlib.boolean:assign_bit_xor", new AssignWithOpFunc(Instr.op_xor));
		coreFuncs.put("kiev.stdlib.boolean:assign_bit_and", new AssignWithOpFunc(Instr.op_and));
		coreFuncs.put("kiev.stdlib.boolean:bit_or",         new BinaryOpFunc(Instr.op_or));
		coreFuncs.put("kiev.stdlib.boolean:bit_xor",        new BinaryOpFunc(Instr.op_xor));
		coreFuncs.put("kiev.stdlib.boolean:bit_and",        new BinaryOpFunc(Instr.op_and));
...
//		coreFuncs.put("kiev.stdlib.boolean:bool_not",       BoolBoolNOT);
		...
		coreFuncs.put("kiev.stdlib.byte:negative",          new UnaryOpFunc(Instr.op_neg));
		...
		coreFuncs.put("kiev.stdlib.short:negative",         new UnaryOpFunc(Instr.op_neg));
		
		coreFuncs.put("kiev.stdlib.int:assign",             new AssignFunc());
		coreFuncs.put("kiev.stdlib.int:assign_bit_or",      new AssignWithOpFunc(Instr.op_or));
		coreFuncs.put("kiev.stdlib.int:assign_bit_xor",     new AssignWithOpFunc(Instr.op_xor));
		coreFuncs.put("kiev.stdlib.int:assign_bit_and",     new AssignWithOpFunc(Instr.op_and));
		...
		coreFuncs.put("kiev.stdlib.int:bit_or",             new BinaryOpFunc(Instr.op_or));
		coreFuncs.put("kiev.stdlib.int:bit_xor",            new BinaryOpFunc(Instr.op_xor));
		coreFuncs.put("kiev.stdlib.int:bit_and",            new BinaryOpFunc(Instr.op_and));
...
//		coreFuncs.put("kiev.stdlib.int:bool_lt",            IntBoolLT);
		coreFuncs.put("kiev.stdlib.int:left_shift",               new BinaryOpFunc(Instr.op_shl));
		coreFuncs.put("kiev.stdlib.int:right_shift",              new BinaryOpFunc(Instr.op_shr));
		coreFuncs.put("kiev.stdlib.int:unsigned_right_shift",     new BinaryOpFunc(Instr.op_ushr));
		coreFuncs.put("kiev.stdlib.int:add",                new BinaryOpFunc(Instr.op_add));
		coreFuncs.put("kiev.stdlib.int:sub",                new BinaryOpFunc(Instr.op_sub));
		coreFuncs.put("kiev.stdlib.int:mul",                new BinaryOpFunc(Instr.op_mul));
		coreFuncs.put("kiev.stdlib.int:div",                new BinaryOpFunc(Instr.op_div));
		...
		coreFuncs.put("kiev.stdlib.long:assign_bit_xor",    new AssignWithOpFunc(Instr.op_xor));
		coreFuncs.put("kiev.stdlib.long:assign_bit_and",    new AssignWithOpFunc(Instr.op_and));
		coreFuncs.put("kiev.stdlib.long:assign_left_shift",            new AssignWithOpFunc(Instr.op_shl));
		coreFuncs.put("kiev.stdlib.long:assign_right_shift",           new AssignWithOpFunc(Instr.op_shr));
		coreFuncs.put("kiev.stdlib.long:assign_unsigned_right_shift",  new AssignWithOpFunc(Instr.op_ushr));
		coreFuncs.put("kiev.stdlib.long:assign_add",        new AssignWithOpFunc(Instr.op_add));
		coreFuncs.put("kiev.stdlib.long:assign_sub",        new AssignWithOpFunc(Instr.op_sub));
		coreFuncs.put("kiev.stdlib.long:assign_mul",        new AssignWithOpFunc(Instr.op_mul));
		coreFuncs.put("kiev.stdlib.long:assign_div",        new AssignWithOpFunc(Instr.op_div));
		coreFuncs.put("kiev.stdlib.long:assign_mod",        new AssignWithOpFunc(Instr.op_rem));
		coreFuncs.put("kiev.stdlib.long:bit_or",            new BinaryOpFunc(Instr.op_or));
		coreFuncs.put("kiev.stdlib.long:bit_xor",           new BinaryOpFunc(Instr.op_xor));
		coreFuncs.put("kiev.stdlib.long:bit_and",           new BinaryOpFunc(Instr.op_and));
...
//		coreFuncs.put("kiev.stdlib.long:bool_lt",           LongBoolLT);
		coreFuncs.put("kiev.stdlib.long:left_shift",              new BinaryOpFunc(Instr.op_shl));
		coreFuncs.put("kiev.stdlib.long:right_shift",             new BinaryOpFunc(Instr.op_shr));
		coreFuncs.put("kiev.stdlib.long:unsigned_right_shift",    new BinaryOpFunc(Instr.op_ushr));
		coreFuncs.put("kiev.stdlib.long:add",               new BinaryOpFunc(Instr.op_add));
		coreFuncs.put("kiev.stdlib.long:sub",               new BinaryOpFunc(Instr.op_sub));
		coreFuncs.put("kiev.stdlib.long:mul",               new BinaryOpFunc(Instr.op_mul));
		coreFuncs.put("kiev.stdlib.long:div",               new BinaryOpFunc(Instr.op_div));
		...
		coreFuncs.put("kiev.stdlib.float:assign_sub",       new AssignWithOpFunc(Instr.op_sub));
		coreFuncs.put("kiev.stdlib.float:assign_mul",       new AssignWithOpFunc(Instr.op_mul));
		coreFuncs.put("kiev.stdlib.float:assign_div",       new AssignWithOpFunc(Instr.op_div));
		coreFuncs.put("kiev.stdlib.float:assign_mod",       new AssignWithOpFunc(Instr.op_rem));
...
//		coreFuncs.put("kiev.stdlib.float:bool_lt",          FloatBoolLT);
		coreFuncs.put("kiev.stdlib.float:add",              new BinaryOpFunc(Instr.op_add));
		coreFuncs.put("kiev.stdlib.float:sub",              new BinaryOpFunc(Instr.op_sub));
		coreFuncs.put("kiev.stdlib.float:mul",              new BinaryOpFunc(Instr.op_mul));
		coreFuncs.put("kiev.stdlib.float:div",              new BinaryOpFunc(Instr.op_div));
		coreFuncs.put("kiev.stdlib.float:mod",              new BinaryOpFunc(Instr.op_rem));
		coreFuncs.put("kiev.stdlib.float:positive",         new UnaryOpFunc(Instr.op_nop));
		coreFuncs.put("kiev.stdlib.float:negative",         new UnaryOpFunc(Instr.op_neg));
		
		coreFuncs.put("kiev.stdlib.double:assign",          new AssignFunc());
		coreFuncs.put("kiev.stdlib.double:assign_add",      new AssignWithOpFunc(Instr.op_add));
		coreFuncs.put("kiev.stdlib.double:assign_sub",      new AssignWithOpFunc(Instr.op_sub));
		coreFuncs.put("kiev.stdlib.double:assign_mul",      new AssignWithOpFunc(Instr.op_mul));
		coreFuncs.put("kiev.stdlib.double:assign_div",      new AssignWithOpFunc(Instr.op_div));
		coreFuncs.put("kiev.stdlib.double:assign_mod",      new AssignWithOpFunc(Instr.op_rem));
...
//		coreFuncs.put("kiev.stdlib.double:bool_lt",         DoubleBoolLT);
		coreFuncs.put("kiev.stdlib.double:add",             new BinaryOpFunc(Instr.op_add));
		coreFuncs.put("kiev.stdlib.double:sub",             new BinaryOpFunc(Instr.op_sub));
		coreFuncs.put("kiev.stdlib.double:mul",             new BinaryOpFunc(Instr.op_mul));
		coreFuncs.put("kiev.stdlib.double:div",             new BinaryOpFunc(Instr.op_div));
		coreFuncs.put("kiev.stdlib.double:mod",             new BinaryOpFunc(Instr.op_rem));
		coreFuncs.put("kiev.stdlib.double:positive",        new UnaryOpFunc(Instr.op_nop));
		coreFuncs.put("kiev.stdlib.double:negative",        new UnaryOpFunc(Instr.op_neg));
	}
