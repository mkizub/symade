...
"%JAVA_HOME%\bin\java.exe" -verify -server -ea -classpath %OUT_ROOT%\classes2;..\bin\xpp3-1.1.4c.jar -Xnoclassgc -Xms512M -Xmx512M kiev.Main -classpath %OUT_ROOT%\classes3;..\bin\xpp3-1.1.4c.jar -d %OUT_ROOT%\classes3 -verify -enable vnode -enable view -p k5x.prj -prop k5x.props -g %*
