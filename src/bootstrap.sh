...
java -ea -verify -Xms256M -Xmx256M -Xfuture -Xnoclassgc -classpath ../bin/symade-05.jar:../bin/xpp3-1.1.4c.jar kiev.Main -classpath ../bin/xpp3-1.1.4c.jar -d ${OUT_ROOT}/symade1 -verify -enable vnode -enable view -p k5.prj -prop k5.props -g 
