...
C:\Sun\Java\jdk1.6.0_06\bin\javac -classpath %OUT_ROOT%\classes4;..\bin\xpp3-1.1.4c.jar -d %OUT_ROOT%\classes4 -encoding "UTF-8" -g kiev\gui\event\*.java 
...
C:\Sun\Java\jdk1.6.0_06\bin\javac -classpath %OUT_ROOT%\classes4;..\bin\xpp3-1.1.4c.jar;..\bin\swt-win.jar;..\bin\org.eclipse.draw2d.jar;..\bin\org.eclipse.jface_3.3.1.M20070910-0800b.jar;..\bin\org.eclipse.equinox.common_3.3.0.v20070426.jar;..\bin\org.eclipse.core.commands_3.3.0.I20070605-0010.jar -d %OUT_ROOT%\classes4 -encoding "UTF-8" -g kiev\gui\*.java kiev\gui\swt\*.java kiev\gui\swing\*.java
