...
C:\Sun\Java\jdk1.6.0_06\bin\javac -classpath %OUT_ROOT%\classes;..\bin\xpp3-1.1.4c.jar -d %OUT_ROOT%\classes -encoding "UTF-8" -g kiev\gui\event\*.java 
