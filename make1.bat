...
"%JAVA_HOME%\bin\java.exe" -ea -verify -Xms512M -Xmx512M -Xfuture -Xnoclassgc -classpath bin\symade-06.jar kiev.Main -classpath %OUT_ROOT%\classes1;bin\swt-win.jar -d %OUT_ROOT%\classes1 -verify -enable vnode -enable view -p k6.prj -prop k6.props -g -target 8 -no-btd %*
