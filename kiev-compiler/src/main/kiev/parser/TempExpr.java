...
public final class UnresOpExpr extends UnresExpr {
	...
	public UnresOpExpr(int pos, COpdef opd, ANode[] exprs) {
		this.pos = pos;
		this.opd = opd;
...
public final class UnresReinterpExpr extends UnresExpr {
	...
	public UnresReinterpExpr(int pos, TypeRef tr, ENode expr) {
		this.pos = pos;
		this.tr = tr;
		this.expr = expr;
	}
...
public class UnresOpTypeRef extends UnresTypeRef {
	...
	public UnresOpTypeRef(int pos, COpdef opd, ANode[] exprs) {
		this.pos = pos;
		this.opd = opd;
		this.exprs.addAll(exprs);
	}
...
public class UnresTypeWithArgs extends UnresTypeRef {
	...
	public UnresTypeWithArgs(int pos, TypeRef base, TypeRef[] args) {
		this.pos = pos;
		this.base = base;
		this.args.addAll(args);
	}
...
public class UnresTypeAccessExpr extends UnresTypeRef {
	...
	public UnresTypeAccessExpr(int pos, TypeRef base, String ident) {
		this.pos = pos;
		this.base = base;
		this.ident = ident;
	}
