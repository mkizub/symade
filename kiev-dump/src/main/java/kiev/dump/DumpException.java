...
public class DumpException extends Exception {
	/**
	 * Constructs an {@code DumpException} with {@code null} as its error detail
	 * message.
	 */
	...
	/**
	 * Constructs an {@code DumpException} with the specified detail message.
	 * 
	 * @param message
	...
	/**
	 * Constructs an {@code DumpException} with the specified detail message and
	 * cause.
	 * 
	 * <p>
	...
	/**
	 * Constructs an {@code DumpException} with the specified cause and a detail
